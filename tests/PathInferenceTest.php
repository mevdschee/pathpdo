...
{
    public function testInferPathsWithFlatJoin()
    {
    ...
    public function testInferPathsWithNestedOneToMany()
    {
        $analyzer = new QueryAnalyzer();
    ...
    public function testInferPathsWithNestedManyToOne()
    {
        $analyzer = new QueryAnalyzer();
    ...
    public function testInferPathsWithAliasHints()
    {
        $analyzer = new QueryAnalyzer();
